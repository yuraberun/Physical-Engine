...
namespace PhysicalEngine.Graphics
{
    ...
    public sealed class PESprites : IDisposable
    {
        ...
        public void Begin(PECamera camera = null, bool textureFiltering = false, SpriteBlendType blendType = SpriteBlendType.Alpha)
        {
