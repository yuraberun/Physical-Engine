...
{
    public sealed class PEScreen : IDisposable
    {
        ...
        public PEScreen(Game game, int width, int height)
        {
            this.isDisposed = false;
            this.game = game ?? throw new ArgumentNullException("game");

            this.Width = PEMathTools.Clamp(width, PEScreen.MinDim, PEScreen.MaxDim);
            this.Height = PEMathTools.Clamp(height, PEScreen.MinDim, PEScreen.MaxDim);
        ...
        public void Present(PESprites sprites)
        {
            this.Present(sprites, Color.Black);
        }

        public void Present(PESprites sprites, Color backgroundColor, bool textureFiltering = true)
        {
            if(this.isSet)
            {
