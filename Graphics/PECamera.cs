...
namespace PhysicalEngine.Graphics
{
    public sealed class PECamera
    {
        ...
        public int Zoom
        {
            ...
            set
            {
                this.zoom = PEMathTools.Clamp(value, PECamera.MinZoom, PECamera.MaxZoom);
        ...
        public PECamera(PEScreen screen)
        {
        ...
        public void Update()
        {
            ...
            this.proj = Matrix.CreatePerspectiveFieldOfView(this.fieldOfView, this.aspectRatio, PECamera.MinZ, PECamera.MaxZ);
        ...
        public void IncZoom()
        {
            ...
            if (new_zoom < PECamera.MinZoom || new_zoom > PECamera.MaxZoom)
            {
                return;
            }
