...
namespace PhysicalEngine.Graphics
{
    public sealed class PEShapes : IDisposable
    {
        private bool isDisposed;
        private Game game;
        private BasicEffect effect;
        private PECamera camera;
        ...
        public void Begin(PECamera camera = null)
        {
            if (this.started)
            {
        ...
        public void DrawBoxFill_Slow(Vector2 center, float width, float height, float rotation, Vector2 scale, Color color)
        {
            ...
            PETransform transform = new PETransform(center, rotation, scale);

            Vector2 a = PEUtils.Transform(new Vector2(left, top), transform);
            Vector2 b = PEUtils.Transform(new Vector2(right, top), transform);
            Vector2 c = PEUtils.Transform(new Vector2(right, bottom), transform);
            Vector2 d = PEUtils.Transform(new Vector2(left, bottom), transform);
        ...
        public void DrawCircleFill(in PECircle circle, int points, Color color)
        {
        ...
        public void DrawCircleFill(float x, float y, float radius, int points, Color color)
        {
            ...
            int shapeVertexCount = PEMathTools.Clamp(points, MinCirclePoints, MaxCirclePoints);    // The vertex count will just be the number of points requested by the user.
        ...
        public void DrawEllipseFill(PEEllipse ellipse, int points, Color color)
        {
        ...
        public void DrawEllipseFill(Vector2 center, Vector2 radius, int points, Color color)
        {
            ...
            int shapeVertexCount = PEMathTools.Clamp(points, MinElipsePoints, MaxElipsePoints);    // The vertex count will just be the number of points requested by the user.
            int shapeTriangleCount = shapeVertexCount - 2;      // The triangle count of a convex polygon is alway 2 less than the vertex count.
            int shapeIndexCount = shapeTriangleCount * 3;       // The indices count will just be 3 times the triangle count.
        ...
        public void DrawPolygonFill(Vector2[] vertices, int[] triangles, PETransform transform, Color color)
        {
            this.EnsureStarted();
            ...
            for (int i = 0; i < vertices.Length; i++)
            {
                ...
                v = PEUtils.Transform(v.X, v.Y, transform);
        ...
        public void DrawPolygonFill(Span<Vector2> vertices, int[] triangles, PETransform transform, Color color)
        {
            this.EnsureStarted();
            this.EnsureSpace(vertices.Length, indices.Length);
        ...
        public void DrawLine(float x1, float y1, float x2, float y2, Color color)
        {
            ...
            PEMathTools.Normalize(ref e1x, ref e1y);
        ...
        public void DrawCircle(in PECircle circle, int points, Color color)
        {
        ...
        public void DrawCircle(float x, float y, float radius, int points, Color color)
        {
            ...
            points = PEMathTools.Clamp(points, MinCirclePoints, MaxCirclePoints);
        ...
        public void DrawEllipse(PEEllipse ellipse, int points, Color color)
        {
        ...
        public void DrawEllipse(Vector2 center, Vector2 radius, int points, Color color)
        {
            ...
            points = PEMathTools.Clamp(points, MinPoints, MaxPoints);
        ...
        public void DrawPolygon_Slow(Vector2[] vertices, Vector2 position, float rotation, Vector2 scale, Color color)
        {
            ...
            PETransform transform = new PETransform(position, rotation, scale);
            ...
            for (int i = 0; i < vertices.Length; i++)
            {
                ...
                a = PEUtils.Transform(a, transform);
                b = PEUtils.Transform(b, transform);
        ...
        public void DrawPolygon(Vector2[] vertices, PETransform transform, Color color)
        {
            if (vertices is null || vertices.Length < 3)
            {
                return;
        ...
        public void DrawPolygon(ReadOnlySpan<Vector2> vertices, PETransform transform, Color color)
        {
        ...
        public void DrawPolygonTriangles(Vector2[] vertices, int[] triangles, PETransform transform, Color color)
        {
            ...
            for(int i = 0; i < triangles.Length; i += 3)
            {
                ...
                a = PEUtils.Transform(a, transform);
                b = PEUtils.Transform(b, transform);
                c = PEUtils.Transform(c, transform);
