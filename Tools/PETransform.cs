...
{
    public readonly struct PETransform
    {
        ...
        public static readonly PETransform Identity = new PETransform(Vector2.Zero, 0f, Vector2.One);

        public static readonly int SizeInBytes = System.Runtime.InteropServices.Marshal.SizeOf(typeof(PETransform));

        public PETransform(Vector2 position, float angle, Vector2 scale)
        {
            this.ScaleX = scale.X;
            this.ScaleY = scale.Y;
            this.angle = angle;
        ...
        public PETransform(Vector2 position, float angle, float scale)
        {
            this.ScaleX = scale;
            this.ScaleY = scale;
            this.angle = angle;
        ...
        public bool Equals(PETransform other)
        {
