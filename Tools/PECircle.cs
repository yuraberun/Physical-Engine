...
{
    public readonly struct PECircle
    {
        ...
        public PECircle(float x, float y, float radius)
        {
            this.Center = new Vector2(x, y);
            this.Radius = radius;
        }

        public bool Equals(PECircle other)
        {
        ...
        {
            float distance = PEMathTools.Distance(this.Center, point);
        ...
        public static bool FindApproximateBoundingCircle(Vector2[] points, out PECircle circle)
        {
            circle = default(PECircle);
            ...
            circle = new PECircle(cx, cy, radius);
            return true;
        }
